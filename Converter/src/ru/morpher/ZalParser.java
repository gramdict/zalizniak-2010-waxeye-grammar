...
public final class ZalParser extends org.waxeye.parser.Parser<ZalType>
{
    ...
    private static void initDef(List<FA<ZalType>> automata) {
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(80), 6, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(10), 7, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(18), 8, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(46), 9, false));
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(79), 12, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(23), 13, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(11), 14, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(79), 15, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(21), 16, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(16), 17, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(15), 18, false));
        states.add(new State<ZalType>(edges, true));
        edges = new ArrayList<Edge<ZalType>>();
