...
public final class ZalParser extends org.waxeye.parser.Parser<ZalType>
{
    ...
    private static void initEntry(List<FA<ZalType>> automata) {
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(44), 4, false));
    ...
    private static void initDef(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(25), 2, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(44), 3, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(9), 4, false));
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(26), 7, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(14), 8, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(23), 9, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(43), 10, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(12), 11, false));
        states.add(new State<ZalType>(edges, true));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(44), 3, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(9), 4, false));
    ...
    private static void initMultiword_index(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(11), 2, false));
        states.add(new State<ZalType>(edges, true));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(10), 1, false));
        states.add(new State<ZalType>(edges, false));
    ...
    private static void initIndex_variants(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(19), 4, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(31), 1, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(31), 1, false));
    ...
    private static void initAlt_lemma(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(44), 11, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(24), 13, false));
    ...
    private static void initIndex(List<FA<ZalType>> automata) {
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(34), 5, false));
        states.add(new State<ZalType>(edges, true));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(34), 5, false));
        states.add(new State<ZalType>(edges, true));
    ...
    private static void initCircledNumberOptional(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(37), 2, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new CharTransition<ZalType>(new char[]{']'}, new char[]{}, new char[]{}), 3, true));
        states.add(new State<ZalType>(edges, false));
    ...
    private static void initNeg_48(List<FA<ZalType>> automata) {
        List<State<ZalType>> states = new ArrayList<State<ZalType>>();
        List<Edge<ZalType>> edges;
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new CharTransition<ZalType>(new char[]{')'}, new char[]{}, new char[]{}), 1, false));
