...
public final class ZalParser extends org.waxeye.parser.Parser<ZalType>
{
    ...
    private static void initDef(List<FA<ZalType>> automata) {
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(78), 11, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(23), 12, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(42), 13, false));
