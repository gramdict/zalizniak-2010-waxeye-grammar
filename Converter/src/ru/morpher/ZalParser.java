...
public final class ZalParser extends org.waxeye.parser.Parser<ZalType>
{
    ...
    private static void initDef(List<FA<ZalType>> automata) {
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(26), 6, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(14), 7, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(23), 8, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(43), 9, false));
