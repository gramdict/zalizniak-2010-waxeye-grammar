...
public final class ZalParser extends org.waxeye.parser.Parser<ZalType>
{
    ...
    private static void initDefs(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, true));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(80), 3, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(9), 1, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(9), 1, false));
    ...
    private static void initDef(List<FA<ZalType>> automata) {
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(80), 8, false));
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(79), 11, false));
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(79), 15, false));
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(79), 18, false));
    ...
    private static void initRef(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(80), 13, false));
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(80), 16, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(79), 17, false));
    ...
    private static void initSee_also(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(80), 23, false));
    ...
    private static void initExamples(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, true));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(80), 5, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(17), 3, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(17), 3, false));
    ...
    private static void initForm(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(80), 14, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(8), 15, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(8), 15, false));
    ...
    private static void initIndex(List<FA<ZalType>> automata) {
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(67), 16, false));
        states.add(new State<ZalType>(edges, true));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new CharTransition<ZalType>(new char[]{'~'}, new char[]{}, new char[]{}), 6, true));
        states.add(new State<ZalType>(edges, false));
    ...
    private static void initAngle_index(List<FA<ZalType>> automata) {
        ...
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new CharTransition<ZalType>(new char[]{'<'}, new char[]{}, new char[]{}), 1, true));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(75), 7, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        ...
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(80), 8, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(66), 6, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(66), 6, false));
        states.add(new State<ZalType>(edges, false));
    ...
    private static void initComment(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(89), 5, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
    ...
    private static void initNeg_84(List<FA<ZalType>> automata) {
        List<State<ZalType>> states = new ArrayList<State<ZalType>>();
        List<Edge<ZalType>> edges;
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new CharTransition<ZalType>(new char[]{'н'}, new char[]{}, new char[]{}), 1, false));
