...
public final class ZalParser extends org.waxeye.parser.Parser<ZalType>
{
    ...
    private static void initEntry(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(56), 6, false));
    ...
    private static void initDef(List<FA<ZalType>> automata) {
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(55), 6, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(36), 7, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(21), 8, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(9), 9, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(32), 10, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(55), 11, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(19), 12, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(14), 13, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(13), 14, false));
        states.add(new State<ZalType>(edges, true));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(56), 3, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(16), 4, false));
    ...
    private static void initOpposite_aspects(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(10), 3, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new CharTransition<ZalType>(new char[]{'/'}, new char[]{}, new char[]{}), 4, true));
        states.add(new State<ZalType>(edges, true));
    ...
    private static void initMultiword_index(List<FA<ZalType>> automata) {
        ...
        List<Edge<ZalType>> edges;
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(17), 1, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(18), 2, false));
        states.add(new State<ZalType>(edges, true));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(17), 1, false));
        states.add(new State<ZalType>(edges, false));
    ...
    private static void initIdioms(List<FA<ZalType>> automata) {
        ...
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(56), 3, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(20), 4, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(20), 4, false));
        states.add(new State<ZalType>(edges, false));
    ...
    private static void initIrregular_forms(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(22), 3, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(22), 3, false));
        states.add(new State<ZalType>(edges, true));
    ...
    private static void initNeg_60(List<FA<ZalType>> automata) {
        List<State<ZalType>> states = new ArrayList<State<ZalType>>();
        List<Edge<ZalType>> edges;
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new CharTransition<ZalType>(new char[]{')'}, new char[]{}, new char[]{}), 1, false));
