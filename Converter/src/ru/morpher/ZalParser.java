...
public final class ZalParser extends org.waxeye.parser.Parser<ZalType>
{
    ...
    private static void initDef(List<FA<ZalType>> automata) {
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(47), 12, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(43), 13, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(79), 14, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(23), 15, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(11), 16, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(79), 17, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(21), 18, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(16), 19, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(15), 20, false));
        states.add(new State<ZalType>(edges, true));
        edges = new ArrayList<Edge<ZalType>>();
    ...
    private static void initComment(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(89), 3, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(87), 5, false));
        edges.add(new Edge<ZalType>(new CharTransition<ZalType>(new char[]{')'}, new char[]{}, new char[]{}), 6, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new WildCardTransition<ZalType>(), 4, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        states.add(new State<ZalType>(edges, true));
