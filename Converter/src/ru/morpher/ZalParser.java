...
public final class ZalParser extends org.waxeye.parser.Parser<ZalType>
{
    ...
    private static void initDef(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(28), 2, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(48), 3, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(12), 4, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(28), 5, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(47), 6, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(29), 7, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(17), 8, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(26), 9, false));
    ...
    private static void initAlt_lemma(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(48), 11, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(27), 13, false));
    ...
    private static void initCircledNumberOptional(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(41), 2, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new CharTransition<ZalType>(new char[]{']'}, new char[]{}, new char[]{}), 3, true));
        states.add(new State<ZalType>(edges, false));
    ...
    private static void initNeg_52(List<FA<ZalType>> automata) {
        List<State<ZalType>> states = new ArrayList<State<ZalType>>();
        List<Edge<ZalType>> edges;
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new CharTransition<ZalType>(new char[]{')'}, new char[]{}, new char[]{}), 1, false));
