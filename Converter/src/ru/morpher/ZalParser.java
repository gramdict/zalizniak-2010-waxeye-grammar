...
public final class ZalParser extends org.waxeye.parser.Parser<ZalType>
{
    ...
    private static void initEntry(List<FA<ZalType>> automata) {
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(61), 4, false));
    ...
    private static void initDef(List<FA<ZalType>> automata) {
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(61), 3, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(17), 4, false));
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(22), 8, false));
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(60), 11, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(20), 12, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(15), 13, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(14), 14, false));
        states.add(new State<ZalType>(edges, true));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(61), 3, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(17), 4, false));
    ...
    private static void initNeg_65(List<FA<ZalType>> automata) {
        List<State<ZalType>> states = new ArrayList<State<ZalType>>();
        List<Edge<ZalType>> edges;
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new CharTransition<ZalType>(new char[]{')'}, new char[]{}, new char[]{}), 1, false));
