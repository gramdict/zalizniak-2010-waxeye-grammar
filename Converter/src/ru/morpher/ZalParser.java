...
public final class ZalParser extends org.waxeye.parser.Parser<ZalType>
{
    ...
    private static void initDef(List<FA<ZalType>> automata) {
        ...
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(27), 2, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(46), 3, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(11), 4, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(27), 5, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(45), 6, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(28), 7, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(16), 8, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(25), 9, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(45), 10, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(14), 11, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(9), 12, false));
        states.add(new State<ZalType>(edges, true));
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(46), 3, false));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(11), 4, false));
    ...
    private static void initAlt_lemma(List<FA<ZalType>> automata) {
        ...
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(26), 13, false));
    ...
    private static void initAngle_index(List<FA<ZalType>> automata) {
        ...
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new CharTransition<ZalType>(new char[]{'<'}, new char[]{}, new char[]{}), 1, true));
        edges.add(new Edge<ZalType>(new AutomatonTransition<ZalType>(42), 6, false));
        states.add(new State<ZalType>(edges, false));
        edges = new ArrayList<Edge<ZalType>>();
    ...
    private static void initNeg_50(List<FA<ZalType>> automata) {
        List<State<ZalType>> states = new ArrayList<State<ZalType>>();
        List<Edge<ZalType>> edges;
        edges = new ArrayList<Edge<ZalType>>();
        edges.add(new Edge<ZalType>(new CharTransition<ZalType>(new char[]{')'}, new char[]{}, new char[]{}), 1, false));
